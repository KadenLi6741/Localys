      ...
      >
        ...
        <div className="mb-4 relative" ref={suggestionsRef}>
          ...
          <input
            ...
            className="w-full bg-[var(--color-charcoal-light)] border border-[var(--color-charcoal-lighter-plus)] rounded-xl px-4 py-2.5 text-sm text-[var(--color-cream)] placeholder-[var(--color-body-text)] focus:outline-none focus:border-[var(--primary)] transition-colors"
          />
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            rows={5}
            className="w-full bg-[var(--color-charcoal-light)] border border-[var(--color-charcoal-lighter-plus)] rounded-xl px-4 py-3 text-sm text-[var(--color-cream)] placeholder-[var(--color-body-text)] focus:outline-none focus:border-[var(--primary)] transition-colors resize-none"
          />
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="flex gap-1 mb-2 bg-[var(--color-charcoal-light)] rounded-lg p-0.5 w-fit">
            <button
              ...
              className={`px-3 py-1 text-xs font-semibold rounded-md transition-all ${mediaType === 'photos' ? 'bg-[var(--primary)] text-black' : 'text-[var(--color-body-text)] hover:text-[var(--color-cream)]'}`}
            >
              Photos
            </button>
            <button
              ...
              className={`px-3 py-1 text-xs font-semibold rounded-md transition-all ${mediaType === 'video' ? 'bg-[var(--primary)] text-black' : 'text-[var(--color-body-text)] hover:text-[var(--color-cream)]'}`}
            >
              Video
            </button>
          </div>
          ...
          {mediaType === 'photos' ? (
            <>
              ...
              {photos.length < 3 && (
                <div
                  ...
                  className="border-2 border-dashed border-[var(--primary)]/40 rounded-xl p-4 text-center cursor-pointer hover:border-[var(--primary)]/70 transition-colors"
                >
                  <p className="text-sm text-[var(--color-body-text)]">
                    Drag & drop or <span className="text-[var(--primary)] font-semibold">click to upload</span> (up to 3)
                  </p>
                  <input
                    ref={fileInputRef}
                    type="file"
            ...
            <>
              {videoPreview ? (
                ...
                >
                  <p className="text-sm text-[var(--color-body-text)]">
                    Drag & drop or <span className="text-[var(--primary)] font-semibold">click to upload</span> (max 100MB)
                  </p>
                  <input
                    ref={videoInputRef}
                    type="file"
              ...
              >
                <svg
                  className={`w-7 h-7 transition-colors ${
                    star <= (hoverStar || starRating) ? 'text-[var(--primary)]' : 'text-[var(--color-charcoal-lighter-plus)]'
                  }`}
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex-1 py-3 rounded-xl font-semibold text-sm bg-[var(--primary)] text-black hover:bg-[var(--primary)]/90 disabled:opacity-40 transition-all active:scale-[0.98]"
          >
