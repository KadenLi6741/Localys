...
export function QRScanner({ onScan, onClose }: QRScannerProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-transparent flex flex-col">
      {/* Header */}
      <div className="flex items-center justify-between p-4 bg-[var(--color-charcoal)]/80">
        <h2 className="text-[var(--text-primary)] font-semibold text-lg">Scan QR Code</h2>
        <button
        ...
        {error ? (
          <div className="flex items-center justify-center h-full p-8">
            <div className="text-center">
              ...
              <button
                onClick={onClose}
                className="bg-[var(--glass-bg)] hover:bg-[var(--glass-bg-strong)] text-[var(--text-primary)] px-6 py-2 rounded-lg"
              >
                Close
              </button>
            </div>
          ...
          <>
            ...
            <p className="absolute bottom-8 left-0 right-0 text-center text-[var(--text-tertiary)] text-sm">
