    ...
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <div className="bg-surface rounded-xl p-3">
          <p className="text-[11px] text-muted-foreground mb-1">Avg Order Value</p>
          <p className="text-lg font-bold text-[var(--primary)]">
            ${stats.averageOrderValue.toFixed(2)}
          </p>
        </div>
        <div className="bg-surface rounded-xl p-3">
          <p className="text-[11px] text-muted-foreground mb-1">Best Selling Day</p>
          <p className="text-lg font-bold text-foreground">{stats.bestSellingDay}</p>
        </div>
        <div className="bg-surface rounded-xl p-3">
          <p className="text-[11px] text-muted-foreground mb-1">Return Rate</p>
          <p className="text-lg font-bold text-[#6BAF7A]">{stats.returnRate}%</p>
        </div>
        <div className="bg-surface rounded-xl p-3">
          <p className="text-[11px] text-muted-foreground mb-1">Month vs Last</p>
