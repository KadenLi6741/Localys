    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      <div className="relative w-full max-w-lg mx-4 mb-4 sm:mb-0 bg-[var(--color-charcoal)] border border-[var(--color-charcoal-lighter-plus)] rounded-2xl shadow-2xl max-h-[80vh] flex flex-col animate-[scaleIn_200ms_ease-out]">
        ...
        <div className="flex items-center justify-between p-6 border-b border-[var(--color-charcoal-lighter-plus)]">
          ...
          <button
            onClick={onClose}
            className="w-11 h-11 flex items-center justify-center rounded-full text-[var(--color-body-text)] hover:text-[var(--color-cream)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)]"
            aria-label="Close"
          >
        ...
        <div className="p-6 border-b border-[var(--color-charcoal-lighter-plus)]">
          <input
            ...
            className="w-full bg-[var(--color-charcoal-light)] border border-[var(--color-charcoal-lighter-plus)] rounded-xl px-4 py-3 text-[var(--color-cream)] placeholder-[#9E9A90]/50 focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent"
            ...
            <div className="space-y-2">
              {searchResults.map((user) => (
                <button
                  ...
                  disabled={creating}
                  className="w-full flex items-center gap-4 p-4 bg-[var(--color-charcoal-light)] hover:bg-[var(--color-charcoal-lighter)] rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)]"
                >
                  {/* Avatar */}
