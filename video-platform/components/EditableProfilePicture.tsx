...
export function EditableProfilePicture({
  ...
  return (
    <div className="relative">
      <div className={`${className} rounded-full bg-[var(--glass-bg-strong)] flex items-center justify-center overflow-hidden`}>
        {preview ? (
          <img
            src={preview}
            alt="Profile"
        ...
        {/* Loading overlay */}
        {loading && (
          <div className="absolute inset-0 bg-[var(--color-charcoal)]/50 flex items-center justify-center rounded-full">
