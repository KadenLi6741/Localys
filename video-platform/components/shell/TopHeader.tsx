  ...
  return (
    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-2 px-3 sm:gap-3 sm:px-6">
        ...
        {/* Menu — hamburger trigger, top-right. Opens the account dropdown
            (Profile lives in the secondary nav now; Settings was removed). */}
        <div className="relative ml-auto shrink-0">
          <button
            ...
            className="flex items-center justify-center rounded-full p-2 text-black transition hover:text-[#f97316] dark:text-white"
          >
