    ...
    return (
      <div className="min-h-screen bg-transparent flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            onClick={() => router.back()}
            className="px-4 py-2 bg-[#f97316] text-white rounded-lg hover:bg-[#ea6a0c]"
          >
            Go Back
          </button>
        </div>
              ...
              <div className="absolute bottom-4 left-4 right-4 flex flex-wrap gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                {video.businesses.custom_messages.map((message, index) => (
                  <button
                    ...
                    className="px-3 py-2 bg-[#f97316]/70 hover:bg-[#ea6a0c]/70 text-white text-sm rounded-lg backdrop-blur-sm transition-all hover:scale-105"
                  >
                    {message}
                  </button>
                ))}
              ...
              <div className="rounded-xl border border-gray-700 bg-gray-800/70 p-4 space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <a
                    ...
                    className="px-3 py-2 bg-[#ea6a0c] hover:bg-[#f97316] text-white text-sm rounded-lg transition"
                  >
