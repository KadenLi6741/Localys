  ...
  return (
    <div className="min-h-screen bg-transparent text-white flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="bg-white/5 border border-[#f97316]/30 rounded-lg p-8 text-center">
          {/* Success Icon */}
          <div className="text-6xl mb-4"></div>

          <h1 className="text-3xl font-bold mb-2 text-[#f97316]">Order Confirmed!</h1>
          ...
          {/* Confirmation Number */}
          {confirmationNumber && (
            <div className="bg-[#f97316]/10 border border-[#f97316]/30 rounded-lg p-6 mb-6">
          ...
          {/* Status Message */}
          <div className="bg-[#f97316]/10 border border-[#f97316]/20 rounded-lg p-4 mb-6">
          ...
          <div className="space-y-3">
            <Link
              href="/profile"
              className="block bg-[#f97316] hover:bg-[#f97316] text-black py-3 rounded-lg transition-all font-semibold"
            >
              Go to Profile
            </Link>
            <Link
